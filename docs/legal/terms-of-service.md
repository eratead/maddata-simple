...
> **Drafting note (not part of the published document):** This is a starting draft tailored to what the MadData application actually does. It is **not legal advice** and should be reviewed by a qualified attorney — ideally one familiar with Israeli contract law and B2B SaaS — before being published. Pay particular attention to §11 (warranties), §12 (limitation of liability), and §16 (governing law). Delete this note before publishing.
