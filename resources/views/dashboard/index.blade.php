...
@push('page-actions')
    ...
    <div x-data="dashDateFilter()" @click.away="openPicker=null" class="relative flex items-center gap-2">
        {{-- Quick preset select --}}
        <select class="hidden sm:block text-xs border border-gray-200 rounded-md px-2 py-1.5 text-gray-600 bg-white focus:outline-none focus:ring-1 focus:ring-[#F97316] cursor-pointer"
...
@endpush
    ...
    <x-page-box
        x-data="{
            ...
            get filteredDateRows()       { const q = this.search.toLowerCase(); return q ? this.dateRows.filter(r => r.date?.toLowerCase().includes(q)) : this.dateRows; },
            get filteredPlacementRows()  { const q = this.search.toLowerCase(); return q ? this.placementRows.filter(r => r.name?.toLowerCase().includes(q)) : this.placementRows; },
        ...
        <div class="flex items-center border-b border-gray-100 px-5 gap-5 overflow-x-auto [&::-webkit-scrollbar]:hidden">
            ...
            <div class="flex items-center gap-2 py-2.5 shrink-0">
                ...
                <select @change="setPerPage($event.target.value)"
                        class="text-xs border border-gray-200 rounded-md px-2 py-1 text-gray-600 bg-white focus:outline-none focus:ring-1 focus:ring-[#F97316]/30 cursor-pointer">
                ...
                <table class="w-full text-xs">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/70">
                            <th class="text-left pl-5 pr-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">Date</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">Impressions</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden sm:table-cell">Visible</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">Clicks</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">CTR</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden md:table-cell">Reach</th>
                            <th x-show="isVideo" class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden lg:table-cell">25%</th>
                            <th x-show="isVideo" class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden lg:table-cell">50%</th>
                            <th x-show="isVideo" class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden lg:table-cell">75%</th>
                            <th x-show="isVideo" class="text-right pr-5 pl-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden lg:table-cell">100%</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
                        <template x-for="row in pagedDateRows" :key="row.date">
                            <tr class="hover:bg-gray-50/60 transition-colors">
                                ...
                                <td class="px-3 py-2.5 text-right text-gray-500 tabular-nums hidden sm:table-cell" x-text="nf(row.visible)"></td>
                                ...
                                <td class="px-3 py-2.5 text-right text-gray-500 tabular-nums hidden md:table-cell" x-text="nf(row.unique)"></td>
                        ...
                        <tr class="border-t-2 border-gray-200 bg-orange-50/30">
                            ...
                            <td class="px-3 py-2.5 text-right font-bold text-gray-700 tabular-nums hidden sm:table-cell">{{ number_format($summary['visible'] ?? 0) }}</td>
                            ...
                            <td class="px-3 py-2.5 text-right font-bold text-gray-700 tabular-nums hidden md:table-cell">{{ number_format($summary['uniques'] ?? 0) }}</td>
        ...
        <div x-show="activeTab === 'placement'" x-cloak style="display:none">
            <div class="overflow-x-auto">
                <table class="w-full text-xs">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/70">
                            <th class="text-left pl-5 pr-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Placement</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">Impressions</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide hidden sm:table-cell">Share</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">Clicks</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap">CTR</th>
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden md:table-cell">Reach</th>
                            <th x-show="isVideo" class="text-right px-3 py-2.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap hidden lg:table-cell">25%</th>
