                ...
                <table class="w-full text-xs">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/70">
                            ...
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold uppercase tracking-wide whitespace-nowrap hidden sm:table-cell cursor-pointer select-none transition-colors hover:text-gray-700" :class="sortDateCol==='visible' ? 'text-[#F97316]' : 'text-gray-500'" @click="toggleDateSort('visible')"><div class="flex items-center justify-end gap-1">Visible <span class="flex flex-col gap-0.5"><svg class="w-1.5 h-1.5" :class="sortDateCol==='visible'&&sortDateDir==='asc' ? 'text-[#F97316]' : 'text-gray-300'" viewBox="0 0 10 6" fill="currentColor"><path d="M5 0L9.33 6H.67z"/></svg><svg class="w-1.5 h-1.5" :class="sortDateCol==='visible'&&sortDateDir==='desc' ? 'text-[#F97316]' : 'text-gray-300'" viewBox="0 0 10 6" fill="currentColor"><path d="M5 6L.67 0H9.33z"/></svg></span></div></th>
                            ...
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold uppercase tracking-wide whitespace-nowrap hidden md:table-cell cursor-pointer select-none transition-colors hover:text-gray-700" :class="sortDateCol==='unique' ? 'text-[#F97316]' : 'text-gray-500'" @click="toggleDateSort('unique')"><div class="flex items-center justify-end gap-1">Reach <span class="flex flex-col gap-0.5"><svg class="w-1.5 h-1.5" :class="sortDateCol==='unique'&&sortDateDir==='asc' ? 'text-[#F97316]' : 'text-gray-300'" viewBox="0 0 10 6" fill="currentColor"><path d="M5 0L9.33 6H.67z"/></svg><svg class="w-1.5 h-1.5" :class="sortDateCol==='unique'&&sortDateDir==='desc' ? 'text-[#F97316]' : 'text-gray-300'" viewBox="0 0 10 6" fill="currentColor"><path d="M5 6L.67 0H9.33z"/></svg></span></div></th>
                ...
                <table class="w-full text-xs">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/70">
                            ...
                            <th class="text-right px-3 py-2.5 text-[10px] font-semibold uppercase tracking-wide whitespace-nowrap hidden md:table-cell cursor-pointer select-none transition-colors hover:text-gray-700" :class="sortPlacementCol==='unique' ? 'text-[#F97316]' : 'text-gray-500'" @click="togglePlacementSort('unique')"><div class="flex items-center justify-end gap-1">Reach <span class="flex flex-col gap-0.5"><svg class="w-1.5 h-1.5" :class="sortPlacementCol==='unique'&&sortPlacementDir==='asc' ? 'text-[#F97316]' : 'text-gray-300'" viewBox="0 0 10 6" fill="currentColor"><path d="M5 0L9.33 6H.67z"/></svg><svg class="w-1.5 h-1.5" :class="sortPlacementCol==='unique'&&sortPlacementDir==='desc' ? 'text-[#F97316]' : 'text-gray-300'" viewBox="0 0 10 6" fill="currentColor"><path d="M5 6L.67 0H9.33z"/></svg></span></div></th>
