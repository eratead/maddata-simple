...
@push('page-title')
    <h1 class="text-sm font-semibold text-gray-800 truncate">Agencies</h1>
@endpush
...
@endpush
    ...
    <x-page-box>
        <x-ui.datatable table-id="agencies-table">
            <table id="agencies-table" class="min-w-full w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500 text-left sortable">
                            <div class="flex items-center gap-2">Agency Name
                        ...
                        <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500 text-left sortable">
                            <div class="flex items-center gap-2">Clients
                                <span class="flex flex-col gap-px ml-auto">
                                    <svg class="w-2.5 h-2.5 sort-icon-asc" viewBox="0 0 10 6" fill="currentColor"><path d="M5 0L9.33 6H.67z"/></svg>
                                    <svg class="w-2.5 h-2.5 sort-icon-desc" viewBox="0 0 10 6" fill="currentColor"><path d="M5 6L.67 0H9.33z"/></svg>
                                </span>
                        ...
                        <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500 text-left sortable">
                            <div class="flex items-center gap-2">Created
                                <span class="flex flex-col gap-px ml-auto">
                                    <svg class="w-2.5 h-2.5 sort-icon-asc" viewBox="0 0 10 6" fill="currentColor"><path d="M5 0L9.33 6H.67z"/></svg>
                                    <svg class="w-2.5 h-2.5 sort-icon-desc" viewBox="0 0 10 6" fill="currentColor"><path d="M5 6L.67 0H9.33z"/></svg>
                                </span>
                ...
                <tbody class="divide-y divide-gray-100 bg-white text-sm">
                    @foreach ($agencies as $agency)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-gray-500 whitespace-nowrap" data-order="{{ $agency->created_at?->timestamp }}">
                            ...
                            <td class="px-4 py-3 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    <form id="delete-agency-{{ $agency->id }}"
