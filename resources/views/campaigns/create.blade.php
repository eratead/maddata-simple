        ...
        @push('page-title')
                <div class="flex items-center gap-2 text-sm min-w-0">
                        <a href="{{ route('campaigns.index') }}"
                                class="text-gray-400 hover:text-gray-600 transition-colors whitespace-nowrap">Campaigns</a>
        ...
        <form id="campaignForm" action="{{ route('campaigns.store') }}" method="POST" class="max-w-3xl space-y-4">
                ...
                <x-page-box class="overflow-hidden">
                        <div class="flex items-center gap-2 px-5 py-3.5 border-b border-gray-100">
                                <div
                                        class="w-6 h-6 rounded-md bg-[#F97316]/10 flex items-center justify-center shrink-0">
                        ...
                        <div class="p-5 space-y-4">
                                ...
                                <div>
                                        ...
                                        <x-text-input id="name" name="name" type="text" required
                                                :value="old('name')" class="mt-1" placeholder="" />
                                        ...
                                        <div x-show="open" x-cloak
                                                ...
                                                <div class="p-2 border-b border-gray-100">
                                                        <div class="relative">
                                                                ...
                                                                <input x-model="search" @click.stop type="text"
                                                ...
                                                <ul class="overflow-y-auto max-h-52 py-1">
                                                        ...
                                                        <li x-show="filtered.length === 0"
                                                                class="px-3 py-3 text-xs text-gray-400 text-center">No
                                                                clients found</li>
                                                </ul>
                                        </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                                <x-input-label for="expected_impressions"
                                                        value="Expected Impressions" />
                                                <x-text-input id="expected_impressions" name="expected_impressions"
                                                        type="number" min="0" :value="old('expected_impressions')" class="mt-1"
                                                        placeholder="0" />
                                        ...
                                        @if (auth()->user()->hasPermission('can_view_budget'))
                                                <div>
                                                        ...
                                                        <x-text-input id="budget" name="budget" type="number"
                                                                min="0" :value="old('budget')" class="mt-1"
                                                                placeholder="0" />
                                ...
                                {{-- Status toggle --}}
                                <div class="pt-4 border-t border-gray-100" x-data="{ state: '{{ old('status', 'active') }}' }">
                                        <input type="hidden" name="status" :value="state">
                                        <div class="flex items-center justify-between">
                                                <div>
                                                        <x-input-label value="Campaign Status" />
                                                        <p class="text-[11px] text-gray-400 mt-0.5">Controls whether
                                                                this campaign is live.</p>
                                                </div>
                                                <div class="relative bg-gray-100 p-1 rounded-lg flex items-center w-44 cursor-pointer shrink-0"
                                                        ...
                                                        <div class="absolute top-1 bottom-1 w-[calc(50%-4px)] rounded-md transition-all duration-300 ease-in-out shadow-sm"
                                                                :class="state === 'active' ? 'left-1 bg-emerald-500' :
                                                                    'left-[calc(50%+3px)] bg-gray-400'">
                                                        </div>
                                                        <div class="flex-1 text-center py-1 text-xs font-semibold relative z-10 transition-colors"
                                                                :class="state === 'active' ? 'text-white' : 'text-gray-500'">
                                                                Active</div>
                                                        <div class="flex-1 text-center py-1 text-xs font-semibold relative z-10 transition-colors"
                                                                :class="state === 'paused' ? 'text-white' : 'text-gray-500'">
                                                                Paused</div>
                                                </div>
                                        </div>
                        ...
                        <x-page-box class="overflow-hidden">
                                ...
                                <button type="button" @click="open = !open"
                                        ...
                                        <div class="flex items-center gap-2">
                                                <div
                                                        class="w-6 h-6 rounded-md bg-[#F97316]/10 flex items-center justify-center shrink-0">
                                                        <svg class="w-3.5 h-3.5 text-[#F97316]" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                ...
                                                <h2 class="text-sm font-semibold text-gray-800">Required Creative Sizes
                                                </h2>
                                        ...
                                        <div class="p-5 space-y-5">
                                                ...
                                                <div>
                                                        <button type="button" @click="toggleGroup(videoSizes)"
                                                                ...
                                                                Video Sizes <span
                                                                        class="normal-case font-normal">(click to
                                                                        toggle all)</span>
                                                        </button>
                                                ...
                                                <div class="pt-4 border-t border-gray-100">
                                                        <x-input-label for="custom_sizes"
                                                                value="Additional Sizes (comma separated)" />
                                                        <input id="custom_sizes" type="text"
