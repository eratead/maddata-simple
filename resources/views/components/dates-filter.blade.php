...
<form x-data="{
    ...
    updateDates(range) {
        ...
        <div class="relative w-full sm:w-auto">
                <select id="date_range" class="w-full sm:w-auto bg-white border border-gray-200 text-gray-700 py-1.5 px-3 pr-8 rounded text-sm focus:outline-none focus:border-gray-400"
                        x-model="range"
